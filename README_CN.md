...
Maary 修改版 [NextChat](https://github.com/ChatGPTNextWeb/NextChat)。
...
3. 在 Vercel 选择并部署，[请查看详细教程](./docs/vercel-cn.md#如何新建项目)。
...
[见项目贡献者列表](https://github.com/Steve-Mr/NextChat-fork/graphs/contributors)
